...
namespace RsSoftweb\RsSecuredownload\Updates;
 ...
 */
class FalUpdateWizard implements UpgradeWizardInterface, ChattyInterface, LoggerAwareInterface
{
     ...
     * @var string
     */
    protected $table = 'tx_rssecuredownload_codes';
     ...
     * @var string
     */
    protected $sourcePath = 'uploads/tx_rssecuredownload/';
     ...
     * @var string
     */
    protected $targetPath = '_migrated/tx_rssecuredownload/';
    ...
    {
        return 'rssecuredownloadEleemnts';
    }
    ...
    {
        return 'Migrate all file relations from tx_rssecuredownload_codes.file to sys_file_references';
    }
    ...
    public function getDescription(): string
    {
        return 'This update wizard goes through all files that are referenced in the'
            . ' tx_rssecuredownload_codes.file field and adds the files to the FAL File Index.'
